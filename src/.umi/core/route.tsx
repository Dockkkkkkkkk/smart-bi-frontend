...
export async function getRoutes() {
  const routes = {"1":{"path":"/user","layout":false,"id":"1"},"2":{"name":"登录","path":"/user/login","parentId":"1","id":"2"},"3":{"path":"/","redirect":"/add_chart","parentId":"ant-design-pro-layout","id":"3"},"4":{"path":"/add_chart","name":"智能分析","icon":"AreaChartOutlined","parentId":"ant-design-pro-layout","id":"4"},"5":{"path":"/my_chart","name":"图表管理","icon":"FolderOpenOutlined","parentId":"ant-design-pro-layout","id":"5"},"6":{"path":"/admin","name":"管理页","icon":"crown","access":"canAdmin","parentId":"ant-design-pro-layout","id":"6"},"7":{"path":"/admin","redirect":"/admin/sub-page","parentId":"6","id":"7"},"8":{"path":"/admin/sub-page","name":"二级菜单","parentId":"6","id":"8"},"9":{"path":"*","layout":false,"id":"9"},"ant-design-pro-layout":{"id":"ant-design-pro-layout","path":"/","isLayout":true},"umi/plugin/openapi":{"path":"/umi/plugin/openapi","id":"umi/plugin/openapi"}} as const;
  return {
    routes,
    routeComponents: {
